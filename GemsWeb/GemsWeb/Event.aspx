...
<asp:Content ID="Content1" ContentPlaceHolderID="cphCENTER" runat="server">
    ...
    <asp:MultiView ID="mvTab" runat="server" ActiveViewIndex="0">
        ...
        <asp:View ID="tab0" runat="server">
            <!-- Event information -->
            <asp:Label ID="eventName" Width="100px" runat="server" Text="Name: " /><asp:Label
                ID="lbleventname" runat="server" /><br />
            <asp:Label ID="eventDate" Width="100px" runat="server" Text="Date: " /><asp:Label
            ...
            <asp:Label ID="eventDescription" Width="100px" runat="server" Text="Description: " /><asp:Label
                ID="lbleventdescription" runat="server" /><br />
            <asp:Label ID="eventwebsite" Width="100px" runat="server" Text="Website: " /><asp:HyperLink
                ID="hypeventwebsite" runat="server" /><br />
            <asp:Label ID="eventPublishInfo" Width="100px" runat="server" Text="Publication Remarks : " /><asp:Label
        ...
        <asp:View ID="tab2" runat="server">
            ...
            <asp:GridView ID="gvGuest" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                AutoGenerateColumns="False" EmptyDataText="No Guest Added">
                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                <Columns>
                    <asp:BoundField DataField="Name" HeaderText="Name">
