            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnSearch" runat="server" Text="Search Events" 
                        OnClick="btnSearch_Click"  Height="30px" Width="160px" />
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <h3><a href="#">List of Events</a></h3>
                    <asp:ListBox ID="lstEvent" runat="server" Height="420px" Width="500px" 
                        OnSelectedIndexChanged="lstEvent_SelectedIndexChanged"></asp:ListBox>
                </td>
            </tr>
        </table>
        <asp:Button ID="btnGO" runat="server" Text="View Event Details" Height="30px" 
            onclick="btnGO_Click" Width="160px" />
    </div>
</asp:Content>
